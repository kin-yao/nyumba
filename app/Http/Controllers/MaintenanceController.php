...
<div id="log-modal"
    ...
    <div class="modal-inner">
        ...
        <form method="POST" action="{{ route('maintenance.store') }}" id="log-form">
            @csrf
            ...
            <div style="display:flex;gap:8px;flex-wrap:wrap">
                <button type="submit" id="log-submit-btn"
...
<div id="update-modal"
    ...
    <div style="background:#fff;border-radius:14px;padding:28px;width:100%;max-width:440px">
        ...
        <form method="POST" id="update-form">
            ...
            <div style="display:flex;gap:8px;flex-wrap:wrap">
                <button type="submit" id="update-submit-btn"
                        style="padding:7px 15px;background:#1a6b52;color:#fff;border:none;border-radius:7px;font-size:13px;font-weight:500;cursor:pointer;font-family:'DM Sans',sans-serif">
                    Save update
                </button>
...
document.getElementById('log-form').addEventListener('submit', function(e) {
    var btn = document.getElementById('log-submit-btn');
    btn.disabled = true;
