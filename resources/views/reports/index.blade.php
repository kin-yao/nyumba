...
<div class="rep-wrap">
    ...
    <div class="rep-grid">
        @foreach([
            ...
            [route('reports.utilities'),        'Utilities',            'Meter readings and utility charges billed per unit',       '#e0f2fe', '#0369a1', '<path d="M4 13V7M7 13V1M10 13V4" stroke="#0369a1" stroke-width="1.3" stroke-linecap="round"/>'],
